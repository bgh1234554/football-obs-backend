    ...
    private static void processSelectedPlayers(ApiFootballClient apiClient, List<Long> playerIds)
        ...
        for (long playerId : playerIds) {
            ...
            if (existingRow != null && !csvNameShort.isBlank()) {
                ...
                nameShort = PersonNameFormatter.buildNameShortAbbrev(apiNameShort, firstName, lastName, nationality);
            ...
            String nameLong = PersonNameFormatter.buildLongName(firstName, lastName, nationality);
    ...
    private static void collectPlayersForTeam(
        ...
        for (JsonNode player : squadResp.get(0).path("players")) {
            ...
            if (profileResp != null && profileResp.isArray() && !profileResp.isEmpty()) {
                ...
                String nameShort   = PersonNameFormatter.buildNameShortAbbrev(p.path("name").asText(""), firstName, lastName, nationality);
